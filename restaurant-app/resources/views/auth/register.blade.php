        ...
        <div class="card">
            ...
            <div class="card-body">
                    <div class="form-group">
                        <input id="fname" type="text" class="form-control form-control-lg @error('Name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="First Name">
