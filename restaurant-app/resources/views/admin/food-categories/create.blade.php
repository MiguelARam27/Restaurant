                        ...
                        <div class="card-body">
                            <form action="#" id="basicform" data-parsley-validate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputCategoryImageUrl" type="text" name="category" data-parsley-trigger="change" required="" placeholder="http://www.billys.com/burgers.jpg" autocomplete="off" class="form-control">
                                </div>
                                <div class="row">
