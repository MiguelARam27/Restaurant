            ...
            <div class="card-body">
                <div class="form-group">
                    <input id="firstName" type="text"
                        ...
                        value="{{ old('firstName') }}" required autocomplete="name" autofocus placeholder="First Name">
                ...
                <div class="form-group">
                    <input id="lastName" type="text"
                        ...
                        value="{{ old('lastName') }}" required autocomplete="name" autofocus placeholder="First Name">
